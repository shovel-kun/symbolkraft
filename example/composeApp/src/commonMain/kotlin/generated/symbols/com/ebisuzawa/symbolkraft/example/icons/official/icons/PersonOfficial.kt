...
public val Icons.PersonOfficial: ImageVector
    get() {
        if (_personOfficial != null) {
            return _personOfficial!!
        }
        _personOfficial = Builder(name = "PersonOfficial", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth = 960.0f, viewportHeight = 960.0f).apply {
...
private var _personOfficial: ImageVector? = null

@Preview
@Composable
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Icons.PersonOfficial, contentDescription = "")
    }
}
